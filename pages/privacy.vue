      ...
      >
        <div class="md-row">
          <div class="md-col">
            ...
            <h3 class="md-mb-2 md-mt-3 md-typography-headline5">
            ...
            <p class="md-typography-font-light md-typography-subtitle1">
              ...
              information. For instance, we use cookies to improve user
              experinece. They are also used to help us understand your
            ...
            <p class="md-typography-font-light md-typography-subtitle1">
              ...
              address,city,town, any form or online contact identifier email,
              name of chat account etc., phone number personally identifiable
              information.
            </p>
            <h3 class="md-mb-2 md-mt-3 md-typography-headline5">
              Third-party links
            ...
            <h3 class="md-mb-2 md-mt-3 md-typography-headline5">Google</h3>
            <p class="md-typography-font-light md-typography-subtitle1">
            ...
            <p class="md-typography-font-light md-typography-subtitle1">
              ...
              emails, you can email us todo at and we will promptly remove you
