<template>
  <section class="md-layout-rel">
    <section class="md-container md-container--box md-layout-rel">
      <div
        class="md-layout--column md-layout md-align md-align--center-center md-my-3"
      >
        <div
          id="start"
        ...
        >
          <div
            class="md-col md-d-none md-d-flex-sm md-col--12-sm md-col--6 md-align md-align--center-center"
          >
            <AuthOnboard />
          </div>
          <div class="md-col md-col--12-sm md-col--6">
...
export default {
  ...
  components: {
    ...
    AuthForgetPassword: () => import('../components/pages/auth/ForgetPassword')
  },
  data: () => ({
    signup: true,
    actionText: 'OK',
