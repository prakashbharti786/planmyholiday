<template>
  <section class="md-layout-rel md-layout rx-full-height md-layout--column">
    ...
    <div class="et-link-block md-layout md-align md-align--center-center">
      New to Taxedwiser?
      <nuxt-link to="/auth/signup" class="md-button md-button--accent"
